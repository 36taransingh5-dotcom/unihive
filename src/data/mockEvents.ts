...
export const mockEvents: Event[] = [
  ...
  // Later Today
  {
    ...
    description: 'Learn the basics of Python programming! Perfect for complete beginners. Bring your laptop with Python installed. Free pizza and drinks!',
    ...
    longitude: -1.3976,
    image_url: null,
    external_link: 'https://forms.gle/python-workshop-2024',
    tags: ['pizza', 'free', 'study'],
  ...
  // Tomorrow
  {
    ...
    description: 'Start your day right with a calming yoga and meditation session. Mats provided. Wear comfortable clothing. Free coffee after!',
  ...
  },
  {
    ...
    description: 'Alumni from Goldman Sachs and JP Morgan will share their experiences and answer questions about breaking into finance. Free donuts!',
    ...
    longitude: -1.3985,
    image_url: null,
    external_link: 'https://eventbrite.co.uk/finance-careers-talk',
    tags: ['donut', 'free', 'careers'],
  ...
  },
  {
    ...
    longitude: -1.3950,
    image_url: null,
    external_link: 'https://forms.gle/badminton-doubles-2024',
    tags: ['competition', 'ticket'],
